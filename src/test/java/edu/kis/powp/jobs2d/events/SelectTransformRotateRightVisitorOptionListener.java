...
public class SelectTransformRotateRightVisitorOptionListener implements ActionListener {
    @Override
    public void actionPerformed(ActionEvent e) {
        DriverCommand command = CommandsFeature.getDriverCommandManager().getCurrentCommand();
        Transformation transformation = TransformationFactory.getClockwiseRotation();
